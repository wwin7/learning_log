...
class EntryForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            "text": forms.Textarea(attrs={"class": "form-control", "rows": 18, "placeholder": "记录今天学到了什么...", "spellcheck": "false"}),
            "tags": forms.TextInput(attrs={"class": "form-control", "placeholder": "输入标签后按回车...", "autocomplete": "off"}),
        }
